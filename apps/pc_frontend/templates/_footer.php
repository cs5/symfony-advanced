...
<?php echo Doctrine::getTable('SnsConfig')->get('footer_after', $siteConfigSettings['footer_after']['Default']); ?>
<?php else: ?>
<?php echo Doctrine::getTable('SnsConfig')->get('footer_before', $siteConfigSettings['footer_before']['Default']); ?>
<?php endif; ?>
</p>
