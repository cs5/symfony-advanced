...
<?php slot('_body'); ?>
<p><?php echo __('Do you wish to login to the following site using your %1% ID?', array('%1%' => $sa_config['site_name'])) ?></p>
<p><code><?php echo $info->trust_root ?></code></p>
<?php end_slot(); ?>

<?php
sa_include_parts('consentForm', 'trustConfirm', array(
  'title'        => __('Login to %1% using your %2% ID', array(
    '%1%' => parse_url($info->trust_root, PHP_URL_HOST),
    '%2%' => $sa_config['site_name'],
  )),
  'body'         => get_slot('_body'),
  'yes_form'     => get_slot('_yes_form'),
  'consent_from' => $sa_config['site_name'],
