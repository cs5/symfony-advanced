...
<title><?php echo __('%site% Administration', array('%site%' => $sa_config['site_name'])) ?></title>
...
<div id="header">
<h1><?php echo link_to(__('%site% Administration', array('%site%' => $sa_config['site_name'])), '@homepage') ?></h1>
