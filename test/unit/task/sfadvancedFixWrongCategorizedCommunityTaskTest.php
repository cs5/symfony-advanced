...
class opInteractiveTaskTestHandlerFixCommunityCategories extends opInteractiveTaskTestHandler
{
  ...
  public function dropSfAdvancedTables()
  {
    $tables = array(
  ...
  public function testMissingSfAdvancedTableError($comment = '')
  {
...
$handler
  ...
  ->dropSfAdvancedTables()
  ->beginTask()
  ->input('y')
  ->testMissingSfAdvancedTableError('Failed when missing SfAdvanced 2 tables')
  ...
  ->output()
  ->testOutput('Created new community from SfAdvanced : 5', 'Created communityE from SfAdvanced 2 data')
  ->output()
